...
const HomeScreen = ({navigation}) => {
    ...
    const filterFoodsByCategory = (categoryName) => {
        const filtered = foods.filter((food) => food.category == categoryName);
    ...
    const ListCategories = () =>{
        ...
        {categories.map((category, index)=>(
            <TouchableOpacity key={index} activeOpacity={0.8}onPress={()=> {setSelectedCategoryIndex(index); filterFoodsByCategory(category.name);}}>
                <View style={{
                    backgroundColor: 
    ...
    return(
        ...
        backgroundColor: COLORS.white
            ...
            <View style = {style.header}>
                ...
                <Image source={require('../../assets/archie.png')}
